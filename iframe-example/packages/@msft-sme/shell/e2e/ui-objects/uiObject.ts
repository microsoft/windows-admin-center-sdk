...
export class UIObject {
  ...
  public async getAttributeAsync(attributeName: string): Promise<string> {
    this.logActionStart('getAttributeAsync');
    let webElement = await this.getCurrentElementAsync();
    let attributeValue = await Utils.getAttributeAsync(webElement, attributeName);
    this.logActionEnd('getAttributeAsync', attributeValue);
