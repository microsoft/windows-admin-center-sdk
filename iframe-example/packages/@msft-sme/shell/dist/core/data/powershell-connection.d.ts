...
import { PowerShellCommand, PowerShellOptions, PowerShellSession, PowerShellSessionRequestOptions } from './powershell';
...
export declare class PowerShellConnection {
     ...
     */
    run(session: PowerShellSession, scriptOrCommand: string | PowerShellCommand): any;
    /**
     * Runs the powershell command on the session.
     *
     * @param session the PowerShell session object.
     ...
     */
    run(session: PowerShellSession, scriptOrCommand: string | PowerShellCommand, options: PowerShellOptions): any;
    /**
     ...
     */
    runBatch(session: PowerShellBatchSession, scriptOrCommandList: string[] | PowerShellCommand[]): any;
    /**
     ...
     * @param options the PowerShell command options.
     */
    runBatch(session: PowerShellBatchSession, scriptOrCommandList: string[] | PowerShellCommand[], options: PowerShellOptions): any;
    /**
     ...
     */
    runBatchSingleCommand(session: PowerShellBatchSession, scriptOrCommand: string | PowerShellCommand): any;
    /**
     * Runs the powershell command on the session.
     *
     * @param session the PowerShellBatch session object.
     ...
     * @param options the PowerShell command options.
     */
    runBatchSingleCommand(session: PowerShellBatchSession, scriptOrCommand: string | PowerShellCommand, options: PowerShellOptions): any;
    /**
