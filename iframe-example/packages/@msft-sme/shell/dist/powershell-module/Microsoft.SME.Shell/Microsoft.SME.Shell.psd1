...
FunctionsToExport = @(
    ...
    'Get-ClusterNodes',
    'Get-ServerInventory',
    'Get-CimFindProcessWithName',
    'Get-CimRegistryKey',
    'Get-CimRegistryValue',
    'Get-CimRegistryValuesOnKey',
    ...
    'New-CimRegistryStringValue',
    'Remove-CimRegistryStringValue',
    'Set-CimRegistryStringValue'
)
