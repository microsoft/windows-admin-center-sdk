...
import { ActionItem, AppContextService, DialogService } from '../../../../../../angular';
import { NotificationState } from '../../../../../../core';
import { AccessService } from '../access.service';
import { SecurityGroupsData } from '../model/securitygroups-data';
export declare class SecurityGroupsBaseComponent implements OnInit {
    private router;
    ...
    loading: boolean;
    securityGroups: SecurityGroupsData[];
    selectedSecGroup: SecurityGroupsData;
    actions: ActionItem[];
    filter: string;
    private securityGroupsSubscription;
    name: string;
    type: string;
    ...
    onNewAction(result: any): void;
    onDeleteAction(result: any): void;
    buildActions(section: string): void;
    showAlert(message: string, state: NotificationState): void;
    onCloseClick(): void;
}
