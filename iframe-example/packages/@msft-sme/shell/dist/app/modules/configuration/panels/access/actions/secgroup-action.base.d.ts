import { ActionButtonAsync, ActionContainer, AppContextService, DialogService } from '../../../../../../angular';
export declare enum ActionType {
    NewSecurityGroup = 0,
    DeleteSecurityGroup = 1,
}
export declare abstract class SecurityGroupActionBase<T> extends ActionButtonAsync<T> {
    ...
    protected showStartingAlert(message: string): void;
    protected showErrorAlert(message: string): void;
    protected showSuccessAlert(message: string): void;
    setActionState(target: T, container: ActionContainer): void;
    protected abstract calculateEnabled(target: T): boolean;
}
