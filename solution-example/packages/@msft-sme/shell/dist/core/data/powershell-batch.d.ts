...
import { PowerShellOptions, PowerShellSessionRequestOptions } from './powershell';
/**
...
export declare class PowerShellBatch {
     ...
     */
    runSingleCommand(command: string, options?: PowerShellOptions): Observable<PowerShellBatchResponseItem[]>;
    /**
     ...
     * @return observable The result of PowerShell batch command.
     */
    run(commandsList: string[], options?: PowerShellOptions): Observable<PowerShellBatchResponseItem[]>;
    /**
     ...
     * @param options The options.
     */
    private enqueue(nodesList, commandList, options?);
    /**
