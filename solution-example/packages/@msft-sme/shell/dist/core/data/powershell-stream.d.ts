...
export declare class PowerShellStream implements WebsocketStreamHandler {
     ...
     */
    run(nodeName: string, script: string, options?: PowerShellStreamOptions): Observable<PowerShellResult>;
    /**
    ...
    private createRequest<T>(nodeName, script, options?);
    private createRequestSimple<T>(nodeName, script, options?);
    private sendRequest(observer, target, requestState, script, options?);
