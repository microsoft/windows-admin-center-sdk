...
export declare class PowerShellRaw implements Disposable {
     ...
     */
    dispose(): void;
    runCommand(command: string, options?: NodeRequestOptions): Observable<any>;
    /**
...
export declare class PowerShell {
     ...
     */
    static createScript(script: string, args?: any, flags?: string[]): string;
    /**
    ...
    readonly nodeName: string;
    /**
     * Run PowerShell command with Observable just with the command.
     *
     * @param command the powershell cmdlet or script.
     * @return Observable<any> the observable to subscribe.
     */
    runRx(command: string): any;
    /**
     * Run PowerShell command with Observable just with the command and options.
     *
     * @param command the powershell cmdlet or script.
     * @param options the powershell options. (interval option is deprecated, use QueryCache to make interval call.)
     */
    runRx(command: string, options: PowerShellOptions): any;
    /**
     ...
     */
    run(command: string, options?: PowerShellOptions): Observable<any>;
    /**
