...
@Component({
    selector: 'sme-ng2-controls-form-v2-tabbed-style-example',
    templateUrl: './schema-form-tabbed-style-example.component.html'
})
export class SchemaFormTabbedStyleExampleComponent {
