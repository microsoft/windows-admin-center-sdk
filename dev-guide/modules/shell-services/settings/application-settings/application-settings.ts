...
/**
 * The Versioned representation of the Application Extension Settings
 */
export class ApplicationSettings extends VersionedObject {
    ...
    public get booleanExample(): boolean {
        return <boolean>this.getProperty(ApplicationSettings.propertyNames.booleanExample);
    }
    ...
    public set booleanExample(value: boolean) {
        this.setProperty(ApplicationSettings.propertyNames.booleanExample, value);
    }
