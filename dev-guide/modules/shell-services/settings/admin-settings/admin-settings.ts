...
/**
 * The Versioned representation of the Admin Extension Settings
 */
export class AdminSettings extends VersionedObject {
    ...
    /**
     * Getter for the latest version of the application settings.
     */
    ...
    public get booleanExample(): boolean {
        return <boolean>this.getProperty(AdminSettings.propertyNames.booleanExample);
    }
    ...
    public set booleanExample(value: boolean) {
        this.setProperty(AdminSettings.propertyNames.booleanExample, value);
    }
     ...
     * this is called iterativly until the current version is equal to the latest version
     */
    protected upgrade() {
